...
export default function Welcome({ firstName = "World" }: WelcomeProps) {
  ...
  return (
    <div className="flex flex-col gap-12 lg:gap-16 my-12 lg:my-16">
      <div className="mx-8 flex flex-col text-center md:gap-2.5 gap-4">
        <p
          className={
      ...
      <Button
        className={
          "mx-auto inline-block" + fadeInAnimation({ isRevealed, delay: 0 })
        }
